...
function Judge(props: { styles?: CSSProperties }) {
  return (
    <SvgIcon style={props.styles}>
      <svg
        width={props.styles?.width || DEFAULT_SIZE}
        height={props.styles?.height || DEFAULT_SIZE}
        viewBox={`0 0 ${props.styles?.height || DEFAULT_SIZE} ${props.styles?.width || DEFAULT_SIZE}`}
        fill="none"
      ...
      >
        <path
          ...
          fill="white"
        />
        <path fillRule="evenodd" clipRule="evenodd" d="M13 4V21H11V4H13Z" fill="white" />
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          ...
          fill="white"
        />
        <path d="M19 17C20.6569 17 22 16.1046 22 15H19H16C16 16.1046 17.3431 17 19 17Z" fill="white" />
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          ...
          fill="white"
        />
        <path d="M5 17C6.65685 17 8 16.1046 8 15H2C2 16.1046 3.34315 17 5 17Z" fill="white" />
        <path
          fillRule="evenodd"
          clipRule="evenodd"
