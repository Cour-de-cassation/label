        ...
        const validateDocumentOptionItem = {
            ...
            onClick: async () => {
                try {
                    ...
                    displayAlert({
                        text: wordings.business.errors.updateDocumentStatusFailed,
                        variant: 'alert',
                        autoHide: true
                    });
                    console.warn(error);
        ...
        const deleteDocument = {
            ...
            onClick: async () => {
                try {
                    ...
                    displayAlert({
                        text: wordings.business.errors.deleteDocumentFailed,
                        variant: 'alert',
                        autoHide: true
                    });
                    console.warn(error);
        ...
        const deleteProblemReportOptionItem = {
            ...
            onClick: async () => {
                try {
                    ...
                    displayAlert({
                        text: wordings.business.errors.deleteProblemReportFailed,
                        variant: 'alert',
                        autoHide: true
                    });
                    console.warn(error);
