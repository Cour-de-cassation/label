...
function buildHeights() {
  ...
  const ADMIN_TREATMENTS_TABLE_HEADER_HEIGHT = '120px';
  const ADMIN_TREATMENTS_TABLE_FOOTER_HEIGHT = '67px';
  const ADMIN_TREATMENTS_TABLE_HEIGHT = `calc(100vh - ${HEADER_HEIGHT} - ${ADMIN_TREATMENTS_TABLE_HEADER_HEIGHT} - ${ADMIN_TREATMENTS_TABLE_FOOTER_HEIGHT})`;
  ...
  return {
    ...
    adminTreatmentsTableFooter: ADMIN_TREATMENTS_TABLE_FOOTER_HEIGHT,
