...
function buildHeights() {
  ...
  const PUBLISHABLE_DOCUMENTS_TABLE_HEIGHT = `calc(100vh - ${HEADER_HEIGHT} - ${PUBLISHABLE_DOCUMENTS_TABLE_HEADER_HEIGHT})`;
  const PUBLISHABLE_DOCUMENTS_HEIGHT = `calc(100vh - ${HEADER_HEIGHT})`;
