  ...
  treatedDocumentsPage: {
    ...
    table: {
      ...
      columnTitles: {
        ...
        date: 'Traité le',
        surAnnotationPseudonymised: { title: 'Sur. (rempl.)', tooltipText: 'Nombre de sur-sannotations remplacées' },
        surAnnotationOther: { title: 'Sur. (autre)', tooltipText: 'Nombre de sur-annotations autres' },
        resizeAnnotationSmaller: { title: 'R.-', tooltipText: 'Sur-annotations partielles (redimensionnements)' },
        subAnnotationSensitive: { title: 'Sous. (sensit.)', tooltipText: 'Sous-annotations sensibles' },
        subAnnotationOther: { title: 'Sous. (autre)', tooltipText: 'Sous-annotations autres' },
      ...
      statistics: {
        ...
        fields: {
          addedAnnotationsCount: {
            sensitive: 'Sous-annotations sensibles',
            other: 'Sous-annotations autres',
          },
          annotationsCount: 'Annotations',
          deletedAnnotationsCount: { anonymised: 'Sur-annotations remplacées', other: 'Sur-annotations autres' },
