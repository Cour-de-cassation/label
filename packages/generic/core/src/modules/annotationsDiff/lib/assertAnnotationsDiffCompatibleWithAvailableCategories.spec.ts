...
describe('assertAnnotationsDiffCompatibleWithAvailableCategories', () => {
  it('should return true', () => {
    const afterAnnotations = [{ category: 'prenom', start: 0, text: 'Benoit', score: 1 }].map(
  ...
  it('should throw', () => {
    const beforeAnnotations = [{ category: 'prenom', start: 0, text: 'Benoit', score: 1 }].map(
      annotationModule.lib.buildAnnotation,
    );
    const afterAnnotations = [
      { category: 'nom', start: 0, text: 'Benoit', score: 1 },
      { category: 'prenom', start: 10, text: 'Benoit', score: 1 },
