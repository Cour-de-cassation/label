...
describe('computeTreatmentInfo', () => {
  ...
  it('should compute the treatments info for a treatment', () => {
    ...
    const previousAnnotations = [
      { start: 29, text: 'Dupuis', category: 'personnePhysiqueNom', score: 1 },
      { start: 41, text: 'his cat', category: 'personnePhysiqueNom', score: 1 },
      { start: 90, text: 'Gaston', category: 'personnePhysiqueNom', score: 1 },
    ].map(annotationModule.lib.buildAnnotation);
    const nextAnnotations = [
      { start: 0, text: 'Spirou', category: 'personnePhysiqueNom', score: 1 },
      { start: 20, text: 'Editions Dupuis', category: 'personneMorale', score: 1 },
      { start: 90, text: 'Gaston', category: 'personnePhysiquePrenom', score: 1 },
    ].map(annotationModule.lib.buildAnnotation);
  ...
  it('should compute the treatments info for a treatment (addition case)', () => {
    ...
    const nextAnnotations = [
      { start: 29, text: 'Gaston', category: 'personnePhysiqueNom', score: 1 },
      { start: 40, text: 'Pierre', category: 'personnePhysiqueNom', score: 1 },
      { start: 65, text: 'Lagaffe', category: 'personnePhysiqueNom', score: 1 },
      { start: 90, text: 'Lagaffe', category: 'adresse', score: 1 },
    ].map(annotationModule.lib.buildAnnotation);
    const annotationsDiff = annotationsDiffModule.lib.computeAnnotationsDiff(previousAnnotations, nextAnnotations);
  ...
  it('should compute the treatments info for a treatment (deletion case)', () => {
    const previousAnnotations = [
      ...
      { start: 40, text: 'Pierre', category: 'personnePhysiqueNom', score: 1 },
      { start: 65, text: 'Lagaffe', category: 'personnePhysiqueNom', score: 1 },
      { start: 90, text: 'Lagaffe', category: 'personneMorale', score: 1 },
    ].map(annotationModule.lib.buildAnnotation);
  ...
  it('should compute the treatments info for a treatment (modification case)', () => {
    const previousAnnotations = [
      ...
      { start: 40, text: 'Pierre', category: 'personnePhysiqueNom', score: 1 },
      { start: 65, text: 'Lagaffe', category: 'personnePhysiqueNom', score: 1 },
      { start: 90, text: 'Thomas', category: 'adresse', score: 1 },
    ].map(annotationModule.lib.buildAnnotation);
    const nextAnnotations = [
      { start: 29, text: 'Gaston', category: 'personnePhysiquePrenom', score: 1 },
      { start: 40, text: 'Pierre', category: 'personnePhysiquePrenom', score: 1 },
      { start: 65, text: 'Lagaffe', category: 'personnePhysiqueNom', score: 1 },
      { start: 90, text: 'Thomas', category: 'personnePhysiqueNom', score: 1 },
    ].map(annotationModule.lib.buildAnnotation);
    const annotationsDiff = annotationsDiffModule.lib.computeAnnotationsDiff(previousAnnotations, nextAnnotations);
  ...
  it('should compute the treatments info for a treatment (resize bigger case)', () => {
    const previousAnnotations = [
      { start: 29, text: 'Gaston', category: 'personnePhysiqueNom', score: 1 },
      { start: 60, text: 'Pierre', category: 'personnePhysiqueNom', score: 1 },
      { start: 90, text: 'Harry', category: 'personnePhysiqueNom', score: 1 },
    ].map(annotationModule.lib.buildAnnotation);
    const nextAnnotations = [
      { start: 29, text: 'Gaston Lagaffe', category: 'personnePhysiquePrenom', score: 1 },
      { start: 60, text: 'Pierre Lagaffe', category: 'personnePhysiquePrenom', score: 1 },
      { start: 90, text: 'Harry Potter', category: 'personnePhysiqueNom', score: 1 },
    ].map(annotationModule.lib.buildAnnotation);
    const annotationsDiff = annotationsDiffModule.lib.computeAnnotationsDiff(previousAnnotations, nextAnnotations);
  ...
  it('should not raise subannotations count if the annotations are split', () => {
    const previousAnnotations = [
      { start: 90, text: 'Harry Potter', category: 'personnePhysiqueNom', score: 1 },
      { start: 10, text: 'Bruni-Sarkozy', category: 'personnePhysiqueNom', score: 1 },
    ].map(annotationModule.lib.buildAnnotation);
    const nextAnnotations = [
      { start: 10, text: 'Bruni', category: 'personnePhysiqueNom', score: 1 },
      { start: 16, text: 'Sarkozy', category: 'personnePhysiqueNom', score: 1 },
      { start: 90, text: 'Harry', category: 'personnePhysiqueNom', score: 1 },
  ...
  it('should not raise surannotations count if the annotations are split', () => {
    ...
    const nextAnnotations = [{ start: 90, text: 'Harry Potter', category: 'personnePhysiqueNom', score: 1 }].map(
  ...
  it('should raise only one subannotation count if the annotations are of the same', () => {
    ...
    const nextAnnotations = [
      { start: 29, text: 'Gaston', category: 'personnePhysiqueNom', score: 1 },
      { start: 40, text: 'Gaston', category: 'personnePhysiqueNom', score: 1 },
    ].map(annotationModule.lib.buildAnnotation);
    const annotationsDiff = annotationsDiffModule.lib.computeAnnotationsDiff(previousAnnotations, nextAnnotations);
