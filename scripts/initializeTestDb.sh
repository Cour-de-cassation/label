...
RUN_MODE=LOCAL node dist/scripts/importAllDocumentsFromSderSinceOrBetween.js --fromDaysAgo 2  -e environments/localEnvironment.json -s settings/settings.json
